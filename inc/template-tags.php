			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'popperscores' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'popperscores_index_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
...
if ( ! function_exists( 'popperscores_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function popperscores_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'popperscores_entry_footer' ) ) :
	...
	function popperscores_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'popperscores' ) );
			if ( $tags_list ) {
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'popperscores' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'popperscores_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function popperscores_post_thumbnail() {
